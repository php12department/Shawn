...
$home_page_pro_r = $db->rpgetData("product", "*", "isDelete=0 AND isDisplayHomePage=1 AND image IS NOT NULL", "id DESC limit 3");
        ...
        <section class="banner-section-main">
			...
			// 		}
               ...
               ?>
                 <div class="slick-slide">
                    <div class="images-item">
                    <!-- /assets/new_home/img/home/slide1.png -->
                        <img src="<?= SITEURL ?>/images/banner/1641151894_1858018banner.jpeg">
                        
                    </div>
                    <div class="banner-caption">
                        <h5>Welcome to Zilli Furniture & Blinds</h5>
                        <h2>BLACK FRIDAY<span>SALE</span></h2>
                        <p>Save up to 70% discount on selected items</p>
                        <a href="<?= SITEURL; ?>product/bedroom/beds/oceanum-king-bed/" class="btn btn-shop">Shop Now</a>
                    </div>
                    <!-- <div class="bottom-text-highlight">
                        <h1>zilli Furniture</h1>
                    </div> -->
                ...
                <div class="col-lg-6">
                     <div class="product-show-left-sec">
                         <ul class="nav nav-tabs">
                              <li class="active"><a class="active" data-toggle="tab" href="#newArrivals">New Arrivals</a></li>
                              <li><a data-toggle="tab" href="#onSale">On Sale</a></li>
                              <li><a data-toggle="tab" href="#bestSeller">Best Seller</a></li>
                         </ul>
                         <div class="tab-content">
                         <?php
                                   $new_arrival_r = $db->rpgetData("product", "*", "isDelete=0  AND isDisplayCategoryPage = 1 AND image IS NOT NULL", "display_order DESC LIMIT 3",0);
                                   $new_arrival_c = @mysqli_num_rows($new_arrival_r);
                                   $best_sell_product_image_r="select pid,cart_id, sum(`totalprice`) from cartitems WHERE cart_id in(SELECT cart_id from payment_history) group by pid order by sum(totalprice) desc limit 10";
                                   ...
                                   $best_sell_r=$db->rpgetData("product","*","isDelete=0 and image IS NOT NULL and id IN (".$pid.")","",0);
                              ?>
                              <div id="newArrivals" class="tab-pane fade in active show">
                                   <div class="row">
                                        <?php
                                        while($new_arrival_d = @mysqli_fetch_array($new_arrival_r))
                                        {
                                             ...
                                             $pro_sub_cate_slug_new_arrival = $db->rpgetValue("sub_category", "slug", " id='" . $new_arrival_d['cate_id'] . "' ");
                                             $pro_sub_sub_cate_slug_new_arrival = $db->rpgetValue("sub_sub_category", "slug", " id='" . $new_arrival_d['cate_id'] . "' ");
                                             ...
                                             $pro_details_new_arrival = SITEURL . "product/" . $pro_cate_slug_new_arrival . "/common/images/no_image.png/";
                                        ...
                                        ?>
                                                  ...
                                                  <a href="<?= $pro_details_new_arrival; ?>">
                                                       <div class="product-item-box-sec">
                                                            <div class="product-item-image mb-4">
                                                                 <img src="<?= SITEURL . PRODUCT . $new_arrival_d['image']; ?>">
                                                            </div>
                                                            <div class="product-info">
                                                                 <p><?= $new_arrival_d['name']; ?></p>
                              ...
                              <div id="onSale" class="tab-pane fade">
                                   ...
                                   while ($home_page_pro_d = @mysqli_fetch_array($home_page_pro_r)) 
                                   {
                                        ...
                                        if ($home_page_pro_sell_price > 0) {
                                            ...
                                            $dis_price = '<a href="#" class="price" style="color:black;"><b>' . CURR . ($home_page_pro_sell_price - $is_discount_product['total_discount']) . '</b><del> ' . CURR . $home_page_pro_price . '</del></a>';
                                        } else {
                              ...
                              <div id="bestSeller" class="tab-pane fade">
                                   ...
                                   <?php
                                        ...
                                        if ($best_sell_d_sell_price > 0) {
                                            ...
                                            $dis_price1 = '<a href="#" class="price" style="color:black;"><b>' . CURR . ($best_sell_d_sell_price - $is_discount_product1['total_discount']) . '</b><del> ' . CURR . $best_sell_d_price . '</del></a>';
                                        } else {
                                   ...
                                   ?>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-6">
                                        <a href="<?= $pro_details_url_best_sell; ?>">
                                             <div class="product-item-box-sec">
                                                  <div class="product-item-image mb-4">
                                                       <img src="<?= SITEURL . PRODUCT . $best_sell_d['image']; ?>">
                                                  </div>
                                                  <div class="product-info">
                                                       <p><?= $best_sell_d['name']; ?></p>
                                                       <h5><?= $dis_price1; ?></h5>
                                                  </div>
                                             </div>
                                             </a>
           ...
           <div class="row">
                <div class="col-lg-6">
                     <div class="discount-offer-left-fix">
                           <img src="assets/img/home/discount1.png">
