                    ...
                    <div class="product-show-left-sec">
                         <div role="tabpanel">
                              ...
                              <div class="tab-content">
                                   <?php
                                        $new_arrival_r = $db->rpgetData("product", "*", "isDelete=0  AND  price !=0 AND image IS NOT NULL and id IN (1872,264,1855,395,1777)","",0);
                                        ...
                                        $best_sell_r=$db->rpgetData("product","*","isDelete=0 AND price !=0 and image IS NOT NULL and id IN (1869,1824,650,657,427,755,1943) ","price DESC",0);
                                   ?>
                                        ...
                                        <div class="owl-carousel" id="owl3">
                                             <?php
                                                  while($best_sell_d = @mysqli_fetch_assoc($best_sell_r))
                                                  {
                                                       ...
                                                       $dis_price1 = '' . CURR . ($best_sell_d_sell_price - $is_discount_product1['total_discount']) . '<del> ' . CURR . $best_sell_d_price . '</del>';
                                                       } else {
     ...
     <div class="highlight-product-section-main"> 
          <div class="container">
               <div class="row">
                    ...
                    $onsale_image_r = $db->rpgetData("product", "*", "isDelete=0 AND isDisplayHomePage=1 AND image IS NOT NULL AND id=618",0);
     ...
     <div class="container">
          <div class="project-carousel slick">
               <div class="slick-slide">
                    ...
                    <img src="assets/new_home/img/home/new_home_cus_blind.png">
               </div>
               <!-- <div class="slick-slide">
                    <img src="assets/img/home/project-carousel-slide.png">
               </div>
           ...
           <div class="row">
                <div class="col-lg-6">
                     <div class="discount-offer-left-fix">
                           <img src="assets/img/home/custom_blind.jpg">
                ...
                <div class="col-lg-6">
                    <div class="discount-offer-right-fix">
                         ...
                         <!--<img src="assets/img/home/discount2.png">-->
                          <img src="assets/new_home/img/home/new_home_Window_Shades.png">
