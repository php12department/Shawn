...
$total_users = $db->rpgetTotalRecord("user","isDelete=0");
$total_products = $db->rpgetTotalRecord("product","isDelete=0");
$total_orders = $db->rpgetTotalRecord("cartdetails","isDelete=0 AND orderstatus!=1");
?>
<!DOCTYPE html>
<html lang="en" >
                                                    ...
                                                    <div class="kt-iconbox__body">
                                                        ...
                                                        <div class="kt-iconbox__desc">
                                                            <h3 class="kt-iconbox__title">
                                                                <a class="kt-link" href="<?= ADMINURL.'manage-product/';?>">Total Products</a>
                                                            </h3>
                                            ...
                                            <div class="kt-portlet kt-iconbox kt-iconbox--success kt-iconbox--animate-slower">
                                                <div class="kt-portlet__body">
                                                    <div class="kt-iconbox__body">
                                                        ...
                                                        <div class="kt-iconbox__desc">
                                                            <h3 class="kt-iconbox__title">
                                                                <a class="kt-link" href="<?= ADMINURL.'manage-user/';?>">Total Users</a>
                                                            </h3>
                                                            <div class="kt-iconbox__content">
                                                                <?=$total_users;?>
                                                            </div>
                                            ...
                                            <div class="kt-portlet kt-iconbox kt-iconbox--success kt-iconbox--animate">
                                                <div class="kt-portlet__body">
                                                    <div class="kt-iconbox__body">
                                                        ...
                                                        <div class="kt-iconbox__desc">
                                                            <h3 class="kt-iconbox__title">
                                                                <a class="kt-link" href="<?= ADMINURL.'manage-order/';?>">Total Orders</a>
                                                            </h3>
                                                            <div class="kt-iconbox__content">
                                                                <?=$total_orders;?> 
                                                            </div>
