...
if(isset($_REQUEST['searchName']) && $_REQUEST['searchName']!=""){
	$ctable_where .= " (
                            ...
                            description like '%".$_REQUEST['searchName']."%' 
						) AND ";
}
...
<table id="kt_table_1" class="table table-striped- table-bordered table-hover table-checkable">
    ...
    if(@mysqli_num_rows($ctable_r)>0)
    {
	    ...
	    <tr>
            ...
            <td><?php echo $db->clean($ctable_d['title']); ?></td>
            <td><?php echo $db->rplimitChar($ctable_d['description'],40); ?></td>
	        <td><?php echo $ctable_d['from_amount']." - ".$ctable_d['to_amount']; ?></td>
