...
$ctable 			= "static_pages";
$ctable1 			= "Static pages";
$parent_page 		= "static-pages"; //for sidebar active menu
$main_page 			= "manage-static-pages"; //for sidebar active menu
$page_title 		= ucwords($_REQUEST['mode'])." ".$ctable1;
$manage_page_url 	= ADMINURL."manage-static-pages/";
$add_page_url 		= ADMINURL."add-static-pages/add/";
$edit_page_url 		= ADMINURL."add-static-pages/edit/".$_REQUEST['id']."/";

$page_name = $description =$title = "";
$meta_title 		= "";
$meta_description 	= "";
$meta_keywords 		= "";
...
{
	$page_name				= $db->clean($_REQUEST['page_name']);
	$page_slug				= $db->rpcreateSlug($_REQUEST['page_name']);
...
if(isset($_REQUEST['id']) && $_REQUEST['id']>0 && $_REQUEST['mode']=="edit")
{
	...
	$page_name				= stripslashes($ctable_d['page_name']);
                                        ...
                                        <form class="kt-form" name="frm" id="frm" action="." method="post" enctype="multipart/form-data">
										    <div class="kt-portlet__body">
												...
												<div class="form-group">
													<label for="name">Page Name <code>*</code></label>
													<input type="text" class="form-control" value="<?php echo $page_name; ?>" id="page_name" name="page_name" <?php echo $readonly_class; ?>>
												</div>
												<div class="form-group">
