...
$add_page_url       = ADMINURL."add-events-comment/add/".$_REQUEST['event_id']."/";
?>
<!DOCTYPE html>
<html lang="en" >
    ...
    <body  class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading"  >
                        ...
                        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
                            <div class="kt-container  kt-container--fluid ">
                                ...
                                <div class="kt-subheader__toolbar">
                                    <?php
                                    //echo $db->getAddButton($ctable,$ctable1,$add_page_url);
                                    ?>
                                </div>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            ...
            function displayRecords(numRecords) {
                ...
                var data_url = "<?php echo ADMINURL?>ajax_get_<?php echo $ctable; ?>.php?show=" + numRecords + "&searchName=" + searchName +"&event_id="+ <?php echo $_REQUEST['event_id']; ?>;
                $("#results" ).html("");
                $(".loading-div").show();
            ...
            function del_conf(id,mainid)
            {
                swal.fire({
                    ...
                    if(e.value)
                    {
                        window.location.href='<?php echo $delete_page_url;?>'+mainid+'/'+id+'/';
                    }
                })
            }
        </script>
