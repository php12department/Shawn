...
$add_page_url       = ADMINURL."add-product-review/add/".$_REQUEST['pid']."/";
?>
<!DOCTYPE html>
<html lang="en" >
    ...
    <body  class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed kt-page--loading"  >
        ...
        <script type="text/javascript">
            ...
            function displayRecords(numRecords) {
                ...
                var data_url = "<?php echo ADMINURL?>ajax_get_<?php echo $ctable; ?>.php?show=" + numRecords + "&searchName=" + searchName +"&pid="+ <?php echo $_REQUEST['pid']; ?>;
                $("#results" ).html("");
                $(".loading-div").show();
            ...
            function del_conf(id,pid)
            {
                swal.fire({
                    ...
                    if(e.value)
                    {
                        window.location.href='<?php echo $delete_page_url;?>'+pid+'/'+id+'/';
                    }
                })
            }
        </script>
