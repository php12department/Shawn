...
$main_page 			= "manage-material"; //for sidebar active menu
$page_title 		= ucwords($_REQUEST['mode'])." ".$ctable1;
$manage_page_url 	= ADMINURL."manage-material/";
$add_page_url 		= ADMINURL."add-material/add/";
$edit_page_url 		= ADMINURL."add-material/edit/".$_REQUEST['id']."/";
