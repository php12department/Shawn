                    ...
                    <div class="kt-grid__item kt-grid__item--fluid  kt-grid__item--order-tablet-and-mobile-1  kt-login__wrapper">
                        ...
                        <div class="kt-login__body">
                            ...
                            <div class="kt-login__form">
                                ...
                                <!--begin::Form-->
                                <form class="kt-form" action="<?php echo ADMINURL."process-forget-pass/"; ?>" method="post" name="frm" id="frm">
                                    ...
                                    <div class="kt-login__actions">
                                        ...
                                        <button id="kt_login_signin_submit" class="btn btn-primary btn-elevate kt-login__btn-primary">Send Email</button>
                                    </div>
                                    <!--end::Action-->
                                </form>
                                <!--end::Form-->
