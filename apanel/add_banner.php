...
if(isset($_REQUEST['submit']))
{
    ...
    $rectanglebox_banner    = ($_REQUEST['rectanglebox_banner']) ? $_REQUEST['rectanglebox_banner'] : 0;
    $rectanglebox_color     = $db->clean($_REQUEST['rectanglebox_color']);
    /*$rectanglebox_color   = ($_REQUEST['rectanglebox_color']) ? $_REQUEST['rectanglebox_color'] : "afafaf";*/
    ...
    else if(isset($_REQUEST['mode']) && $_REQUEST['mode']=="edit")
    {
        ...
        $rows   = array(
                ...
                "image"                 => $image_path,
                "rectanglebox_banner"   => $rectanglebox_banner,
                "rectanglebox_color"    => $rectanglebox_color,
...
if(isset($_REQUEST['id']) && $_REQUEST['id']>0 && $_REQUEST['mode']=="edit")
{
    ...
    $rectanglebox_banner    = stripslashes($ctable_d['rectanglebox_banner']);
    $rectanglebox_color     = stripslashes($ctable_d['rectanglebox_color']);
                                        ...
                                        <form class="kt-form" name="frm" id="frm" action="." method="post" enctype="multipart/form-data">
                                            <div class="kt-portlet__body">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="ans">Title <span class="text-danger">*</span></label>
                                                    <textarea class="form-control summernote" id="title" name="title"><?php echo $title; ?></textarea>
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="ans">Sub Title <span class="text-danger">*</span></label>
                                                    <textarea class="form-control summernote" id="sub_title" name="sub_title"><?php echo $sub_title; ?></textarea>
                                                    <div class="desc_error"></div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="isProduct_sale">Image <span class="text-danger">*</span>
                                                    <input type="hidden" name="filename" id="filename" class="form-control" />
                                                    </label>
                                                    <small>minimum image size 1920 x 1080</small> 
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div id="dropzone" class="dropzone custom-dropzone" data-width="1920" data-height="1080" data-ghost="false" data-originalsize="false" data-url="<?php echo ADMINURL?>crop_banner_image.php" style="width: 960px;height:540px;">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label>Is Rectanglebox?</label>
                                                    <div class="kt-radio-inline">
                                                        <label class="kt-radio">
                                                            <input type="radio" name="rectanglebox_banner" value="0" <?php if($rectanglebox_banner=="0"){ echo "checked";}?>> No
                                                        <span></span>
                                                        </label>
                                                        <label class="kt-radio">
                                                            <input type="radio" name="rectanglebox_banner" value="1" <?php if($rectanglebox_banner=="1"){ echo "checked";}?>> Yes
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="col-md-6 form-group">
                                                    <label>Rectangle Box Color</label>
                                                    <input type="color"  class="form-control" value="<?php echo $rectanglebox_color; ?>" id="rectanglebox_color" name="rectanglebox_color">
                                                </div>
