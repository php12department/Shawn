...
if (isset($_REQUEST['submit'])) {
	...
	$pro_type				= $db->clean($_REQUEST['pro_type']);
	$pro_type_slug			= $db->rpcreateSlug($_REQUEST['name']);
	...
	if (isset($_FILES['image_path']) && !empty($_FILES['image_path']['name'])) {
		...
		$image_path = time() . "-pro-" . $img_filename;
            ...
            $filename_without_ext = substr($image_path, 0, strrpos($image_path, "."));
            $image_path = $filename_without_ext.".webp";
	...
	if (isset($_REQUEST['mode']) && $_REQUEST['mode'] == "add") {
		...
		if ($r) {
			...
			$last_id = $db->rpinsert($ctable, $values, $rows,0);
			...
			if ($last_id != 0) {
				foreach ($_REQUEST['additional_field'] as $key => $value) {
					...
					if($additional_field_value=="" || empty($additional_field_value))
					{
					...
					$insert_details = $db->rpinsert("product_additional_field_details", $values3, $rows3,0);
				}
				$path = '../images/qrcode/';
				$file = $path . "qrcode_" . $last_id . ".png";
		...
		if ($r) {
			...
			$path = '../images/qrcode/';
			$file = $path . "qrcode_" . $_REQUEST['id'] . ".png";
			$text = "Product Name:".$name."\nProduct Price : " .CURR. $price;
...
if (isset($_REQUEST['id']) && $_REQUEST['id'] > 0 && $_REQUEST['mode'] == "edit") {
	...
	$pro_type				= stripslashes($ctable_d['pro_type']);
	$pro_type_slug			= stripslashes($ctable_d['pro_type_slug']);
									...
									<form class="kt-form" name="frm" id="frm" action="." method="post" enctype="multipart/form-data" accept-charset="UTF-8" onsubmit="return form_submit();">
										<div class="kt-portlet__body">
											...
											<div class="form-group col-md-6">
												...
												<input type="text" class="form-control" value="<?php echo htmlentities($pro_type); ?>" id="pro_type" name="pro_type">
											</div>
											...
											<div class="form-group col-md-6">
												...
												<div class="kt-radio-inline">
													<label class="kt-radio">
														<input type="radio" name="isImage" value="0" <?php if ($isImage == "0") {
																											echo "checked";
																										} ?>> None
														<span></span>
													</label>
													<label class="kt-radio">
														<input type="radio" name="isImage" value="1" <?php if ($isImage == "1") {
																											echo "checked";
																										} ?>> Left
														<span></span>
													</label>
													<label class="kt-radio">
														<input type="radio" name="isImage" value="2" <?php if ($isImage == "2") {
																											echo "checked";
																										} ?>>Right
														<span></span>
													</label>
											...
											<div class="form-group col-md-6">
												...
												<div class="custom-file">
													<input type="file" required class="custom-file-input" id="image_path" name="image_path">
											...
											<div class="form-group col-md-6">
												...
												<select class="form-control" name="status" id="status">
													...
													<option <?php if ($status == "2") {
																echo "selected";
															} ?> value="2">Out Of Stock</option>
													<option <?php if ($status == "3") {
																echo "selected";
															} ?> value="3">Special Order</option>
													<option <?php if ($status == "4") {
																echo "selected";
															} ?> value="4">Online Only</option>
													<option <?php if ($status == "5") {
																echo "selected";
															} ?> value="5">Coming Soon</option>
													<option <?php if ($status == "6") {
																echo "selected";
															} ?> value="6">Special Order (14-16 weeks)</option>
													<option <?php if ($status == "7") {
																echo "selected";
															} ?> value="7">Special Order (2-4 weeks)</option>
												</select>
											</div>
											...
											<div class="form-group col-md-6">
												...
												<div class="kt-radio-inline">
													<label class="kt-radio">
														<input type="radio" name="isProduct" value="0" <?php if ($isProduct == "0") {
																											echo "checked";
																										} ?>> None
														<span></span>
													</label>
													<label class="kt-radio">
														<input type="radio" name="isProduct" value="1" <?php if ($isProduct == "1") {
																											echo "checked";
																										} ?>> Trending
														<span></span>
													</label>
													<label class="kt-radio">
														<input type="radio" name="isProduct" value="2" <?php if ($isProduct == "2") {
																											echo "checked";
																										} ?>>New
														<span></span>
													</label>
											...
											<div class="form-group col-md-6">
												...
												<div class="kt-radio-inline">
													<label class="kt-radio">
														<input type="radio" name="isDisplayHomePage" value="0" <?php if ($isDisplayHomePage == "0") {
																													echo "checked";
																												} ?>> No
														<span></span>
													</label>
													<label class="kt-radio">
														<input type="radio" name="isDisplayHomePage" value="1" <?php if ($isDisplayHomePage == "1") {
																													echo "checked";
																												} ?>> Yes
														<span></span>
													</label>
												</div>
												<!-- <span class="form-text text-muted">(Maximum 4 products are allow.)</span> -->
											...
											<div class="form-group col-md-6">
												...
												<div class="kt-radio-inline">
													<label class="kt-radio">
														<input type="radio" name="isDisplayCategoryPage" value="0" <?php if ($isDisplayCategoryPage == "0") {
																														echo "checked";
																													} ?>> No
														<span></span>
													</label>
													<label class="kt-radio">
														<input type="radio" name="isDisplayCategoryPage" value="1" <?php if ($isDisplayCategoryPage == "1") {
																														echo "checked";
																													} ?>> Yes
														<span></span>
													</label>
											...
											<div class="form-group col-md-6">
												...
												<div class="kt-radio-inline">
													<label class="kt-radio">
														<input type="radio" name="isEnquiry_product" value="0" <?php if ($isEnquiry_product == "0") {
																													echo "checked";
																												} ?>> No
														<span></span>
													</label>
													<label class="kt-radio">
														<input type="radio" name="isEnquiry_product" value="1" <?php if ($isEnquiry_product == "1") {
																													echo "checked";
																												} ?>> Yes
														<span></span>
													</label>
											...
											<div class="form-group col-md-6 mb-0">
												<label>Select Additional Fields Detailsss :-
												</label>
											</div>
											<div class="filed">
																...
																<div class="kt-checkbox-inline">
																	...
																	?>
																		<label class="kt-checkbox kt-checkbox--bold kt-checkbox--success">
																			<input type="checkbox" name="additional_field_value[<?php echo $addon_id ?>][]" <?php
											...
											<!-- <div class="form-group form-group-last">
													...
													<div class="kt-checkbox-inline">
														<label class="kt-checkbox">
															<input type="checkbox" name="is_trending" id="is_trending" value="1" <?php if ($is_trending == "1") {
																																		echo "checked";
																																	} ?>> Trending
															<span></span>
														</label>
														<label class="kt-checkbox">
															<input type="checkbox" name="is_top_new" id="is_top_new" value="1" <?php if ($is_top_new == "1") {
																																	echo "checked";
																																} ?>> New
															<span></span>
														</label>
		...
		$(function() {
			$("#frm").validate({
				...
				messages: {
					...
					filename: {
						required: "Please click on right tick mark after upload image."
					},
					isDisplayHomePage: {
						required: "Maximum 4 products are allow."
					},
					isDisplayCategoryPage: {
						required: "Please select option."
					},
				...
				errorPlacement: function(error, element) {
					if (element.attr("name") == "image_path") {
						error.insertAfter("#custom-file-input");
		...
		function form_submit() {
			...
			if ($("#frm").valid()) {
				...
				$(".filed_class").filter(function(index) {
					...
					if (index == 0) {
						if (additional_field == "" || additional_field == null) {} else {
