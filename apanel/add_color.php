...
$main_page 			= "manage-color"; //for sidebar active menu
$page_title 		= ucwords($_REQUEST['mode'])." ".$ctable1;
$manage_page_url 	= ADMINURL."manage-color/";
$add_page_url 		= ADMINURL."add-color/add/";
$edit_page_url 		= ADMINURL."add-color/edit/".$_REQUEST['id']."/";
