    ...
    <div class="container h-100">
      <div class="row text-center justify-content-center align-items-center h-100">
        ...
        <div class="col-12 col-md-8">
          ...
          <p>Thanks a bunch for filling that out. It means a lot to us, just like you do! We really appreciate you giving us a moment of your time today. Thanks for sharing your photos with us.</p>
          <a href="<?= SITEURL?>customer-gallary/" class="banner-btn hover-effect-span left-arrow">Back to Gallery
              <span class="icon">
