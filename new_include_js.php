<script>
 ...
 <!-- JavaScript Library -->
 <script src="<?php echo SITEURL;?>assets/new_home/js/jquery.min.js"></script>
...
<script src="<?php echo SITEURL;?>assets/js/main.js"></script> -->
 ...
 <!-- <script src="<?php echo SITEURL;?>assets/new_home/js/popper.min.js"></script>
 <script src="<?php echo SITEURL;?>assets/new_home/js/bootstrap.js"></script> -->
 <script src="<?php echo SITEURL;?>assets/new_home/js/slick.js"></script>
 <script src="<?php echo SITEURL;?>assets/new_home/js/jquery.magnific-popup.min.js"></script>
 <script src="<?php echo SITEURL;?>assets/new_home/js/custom.js"></script>
 <script src="<?php echo SITEURL;?>assets/js/owl.carousel.min.js"></script>
...
<script defer src="https://connect.podium.com/widget.js#ORG_TOKEN=b5735759-0585-429b-b19d-b9cb6b8ee453" id="podium-widget" data-organization-api-token="b5735759-0585-429b-b19d-b9cb6b8ee453"></script>
