<header class="site-header homepage-new-header-sec">
                ...
                <ul class="navbar-nav right-navbar">
                    <form action="<?php echo SITEURL; ?>search/" method="GET" class="header-search">
                        <li class="nav-item search-input">
                            ...
                            <button type = "submit"><i class="fa-regular fa-magnifying-glass mr-3"></i></button>
                        </li>
                    </form>
                    <li class="nav-item search-input">
    ...
    <div class="main-navabr" id="mobile-menu">
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <ul class="navbar-nav right-navbar top-navbar-fix">
                    <form action="<?php echo SITEURL; ?>search/" method="GET" class="header-search">
                        <li class="nav-item search-input">
                            <input class="nav-link" type="text" placeholder="Search..." value="" maxlength="70" name="r">
                            <button type = "submit"  style="border: none;background: rgba(0,0,0,0) none repeat scroll 0 0;"><i class="fa-regular fa-magnifying-glass mr-3"></i></button>
                        </li>
                    </form>
                    <li class="nav-item search-input">
                    <a class="nav-link" href="javascript:void(0)" data-toggle="dropdown" aria-expanded="false"> <i class="fa-regular fa-cart-shopping"></i></a>
                        <div class="dropdown-menu cart-dropdown fixed-height-cart-dropdown header_cart"></div>
                    </li>
                    ...
                    <?php
                            ...
                            {
                                ?>
                                    <a class="nav-link" data-toggle="dropdown" aria-expanded="false" href="<?= SITEURL; ?>login/"><i class="fa-regular fa-user"></i></a>
                                    <div class="dropdown-menu user-profile">
                                        <a href="<?php echo SITEURL ?>my-account/" class="dropdown-item">My Account</a>
                                        <a href="<?php echo SITEURL ?>change-password/" class="dropdown-item">Change Password</a>
                                        <a href="<?php echo SITEURL ?>logout/" class="dropdown-item">Log Out</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <!-- <ul class="navbar-nav right-navbar">
                    <form action="<?php echo SITEURL; ?>search/" method="GET" class="header-search">
                        <li class="nav-item search-input">
                            <input class="nav-link" type="text" placeholder="Search..." value="" maxlength="70" name="r">
                            <button type = "submit"  style="background: rgba(0,0,0,0) none repeat scroll 0 0;"><i class="fa-regular fa-magnifying-glass mr-3"></i></button>
                        </li>
                    </form>
                    <li class="nav-item search-input">
                    <a class="nav-link" href="javascript:void(0)" data-toggle="dropdown" aria-expanded="false"> <i class="fa-regular fa-cart-shopping"></i></a>
