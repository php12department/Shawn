          ...
          <div class="row mx-0">
                         ...
                         <div role="tabpanel">
                              ...
                              <div class="tab-content">
                                   ...
                                   <div role="tabpanel" class="tab-pane active show" id="home">
                                        ...
                                        <?php 
                                        if($new_arrival_d['id']==264)
                                        {
                                            ?>
                                            <img src="<?= SITEURL . PRODUCT?>pro-Heritage_Large_Dining_Table.webp" alt="<?php echo SITEURL; ?>">
                                            <?php
                                        }
                                        else
                                        {
                ...
                <div class="col-lg-6 px-0">
                     <div class="product-show-right-image">
                           <img src="assets/img/home/highlight-image.webp">
     ...
     <div class="container">
          <div class="project-carousel slick">
               <div class="slick-slide">
                    ...
                    <img src="assets/new_home/img/home/new_home_cus_blind.webp" alt="<?php echo SITETITLE; ?>">
               </div>
               <!-- <div class="slick-slide">
                    <img src="assets/img/home/project-carousel-slide.png">
               </div>
           ...
           <div class="row">
                <div class="col-lg-6">
                     <div class="discount-offer-left-fix">
                           <img src="assets/img/home/custom_blind.webp" alt="<?php echo SITETITLE; ?>">
                ...
                <div class="col-lg-6">
                    <div class="discount-offer-right-fix">
                         ...
                         <a href="<?= $hp_button_link; ?>" class="btn theme-btn"><?= $hp_button_name; ?></a>
                         </div>
                              </center>
                         <?php } ?>
                         <!--<img src="assets/img/home/discount2.png">-->
                          <img src="assets/new_home/img/home/new_home_Window_Shades.webp" alt="<?php echo SITETITLE; ?>">
                                   ...
                                   <div class="col-lg-4 col-md-6">
                                        ...
                                        <div class="shop-room-box-sec">
                                             ...
                                             <h4><?php
                                                  ...
                                                  ?>
                                                  <span><i class="fa-light fa-arrow-right-long"></i></span></h4>
                                        </div>
                                        </a>
                                   </div>
          ...
          <div class="row">
               <div class="left-chair-image-fix">
                    <!--<img src="assets/img/home/left-chair.png" alt="<?php echo SITETITLE; ?>">-->
                     <img src="assets/img/home/left-chair.webp" alt="<?php echo SITETITLE; ?>">
               </div>
                    ...
                    <div class="newsletter-form-sec-fix">
                         ...
                         <form class="newsletter-form" action="javascript:;" name="frmsubscribe" id="frmsubscribe" method="post">
                              <div class="form-group"> 
                               ...
                               <div class="form-group"> 
                                   <button type="submit" name="subscribe" id="subscribe" class="btn subscribe-btn">Subscribe
                                    </button>
                              </div>
                         </form>
                    </div>
...
$('.slick').slick({
  ...
  autoplaySpeed: 5000 // set the autoplay speed in milliseconds (e.g., 2000 for 2 seconds per slide)
});
