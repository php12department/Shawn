<?php
include('connect.php');
$brand_id  = $db->clean($_REQUEST['brand_id']);

if (isset($_REQUEST['cate_id']) && $_REQUEST['cate_id'] != "") {
	$cate_id_arr = implode(",", $_REQUEST['cate_id']);
	$ctable_where .= "cate_id IN ($cate_id_arr) AND ";
}
...
$ctable_where .= "pro_feature_brand='" . $brand_id . "' AND isDelete=0";
$ctable_r = $db->rpgetData("product", "*", $ctable_where, $orderBy);
...
?>
		<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-xs-12 p-0-10">
	...
	<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<h3 class="text-center mt-30">No product found.</h3>
	</div>
<?php
}
?>